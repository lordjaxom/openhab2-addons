 ...
 */
class MoritzMessageTest {

    @Test
    void setTemperature_message() {
    ...
    @Test
    void linkPartnerRemove_message() {
    ...
    @Test
    void wallThermostatControl_message() {
    ...
    @Test
    void timeInformationEmpty_parse() {
